Reference the general gradient definition defined below.

Our aim is to construct a very simple marketing/landing page for v1 of launch for establishing aesthetic vibes and "proof-of-life" for partners, clients, investors, and other such prospects.

We can use Astro latest GA release since we also want to think about publishing content and blogs on a resource on this page without much fuss.
...
```
/* Antiswarm-holding-page-draft3 */


background: linear-gradient(180deg, #290036 50.17%, #7D1132 100%);
```